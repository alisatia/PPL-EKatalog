				...
				<div class="subheader row" style="margin: 0px 10%;  height:50px">
					...
					<div class="navigasi col-md-4 d-flex">
						<div class="h-75 w-100 m-auto row">
							<div class="home col m-auto fw-bold"><a  class="border rounded-2 p-2" style="color: #cc0000; text-decoration: none" href="index.php">Home</a></div>
							...
							<a class="login btn col m-auto text-white fw-bold" style="background-color:#cc0000" href="index.php">Login</a>
						</div>
					</div>
				</div>
			</div>
